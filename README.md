...
```ts
import type * as CSS from '@lambrioanpm/accusamus-animi-quae';
...
```js
// @flow strict
import * as CSS from '@lambrioanpm/accusamus-animi-quae';
...
```sh
$ npm install @lambrioanpm/accusamus-animi-quae
```
...
2.  **Have a look in [issues](https://github.com/lambrioanpm/accusamus-animi-quae/issues) to see if an issue already has been filed. If not, create a new one.** To help us out, please refer to any information you have found.
3.  Fix the issue locally with **TypeScript** (Flow further down):
    ...
    - The recommended way is to use **module augmentation**. Here's a few examples:
      ...
      declare module '@lambrioanpm/accusamus-animi-quae' {
